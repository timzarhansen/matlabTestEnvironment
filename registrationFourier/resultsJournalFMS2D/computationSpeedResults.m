...
for i = 1:4
    ...
    resultListOfInterest = resultsExperiment(resultsExperiment(:,2) ==voxelSize,:);
    resultListOfInterest1 = resultListOfInterest(resultListOfInterest(:,1) ==1,:);% method
    resultListOfInterest1 = resultListOfInterest1(resultListOfInterest1(:,3) ==1,:);%init guess



    resultListOfInterest2 = resultListOfInterest(resultListOfInterest(:,1) ==3,:);% method
    resultListOfInterest2 = resultListOfInterest2(resultListOfInterest2(:,3) ==1,:);%init guess

        resultListOfInterest3 = resultListOfInterest(resultListOfInterest(:,1) ==4,:);% method
    resultListOfInterest3 = resultListOfInterest3(resultListOfInterest3(:,3) ==1,:);%init guess

        resultListOfInterest4 = resultListOfInterest(resultListOfInterest(:,1) ==5,:);% method
    resultListOfInterest4 = resultListOfInterest4(resultListOfInterest4(:,3) ==1,:);%init guess



        resultListOfInterest5 = resultListOfInterest(resultListOfInterest(:,1) ==6,:);% method
    resultListOfInterest5 = resultListOfInterest5(resultListOfInterest5(:,3) ==1,:);%init guess

        resultListOfInterest6 = resultListOfInterest(resultListOfInterest(:,1) ==6,:);% method
    resultListOfInterest6 = resultListOfInterest6(resultListOfInterest6(:,3) ==0,:);%init guess

        resultListOfInterest7 = resultListOfInterest(resultListOfInterest(:,1) ==7,:);% method
    resultListOfInterest7 = resultListOfInterest7(resultListOfInterest7(:,3) ==1,:);%init guess

        resultListOfInterest8 = resultListOfInterest(resultListOfInterest(:,1) ==7,:);% method
    resultListOfInterest8 = resultListOfInterest8(resultListOfInterest8(:,3) ==0,:);%init guess

        resultListOfInterest9 = resultListOfInterest(resultListOfInterest(:,1) ==8,:);% method
    resultListOfInterest9 = resultListOfInterest9(resultListOfInterest9(:,3) ==1,:);%init guess

        resultListOfInterest10 = resultListOfInterest(resultListOfInterest(:,1) ==8,:);% method
    resultListOfInterest10 = resultListOfInterest10(resultListOfInterest10(:,3) ==0,:);%init guess

        resultListOfInterest11 = resultListOfInterest(resultListOfInterest(:,1) ==9,:);% method
    resultListOfInterest11 = resultListOfInterest11(resultListOfInterest11(:,3) ==0,:);%init guess

        resultListOfInterest12 = resultListOfInterest(resultListOfInterest(:,1) ==10,:);% method
    resultListOfInterest12 = resultListOfInterest12(resultListOfInterest12(:,3) ==0,:);%init guess

        resultListOfInterest13 = resultListOfInterest(resultListOfInterest(:,1) ==11,:);% method
    resultListOfInterest13 = resultListOfInterest13(resultListOfInterest13(:,3) ==0,:);%init guess

        resultListOfInterest14 = resultListOfInterest(resultListOfInterest(:,1) ==12,:);% method
    resultListOfInterest14 = resultListOfInterest14(resultListOfInterest14(:,3) ==0,:);%init guess

        resultListOfInterest15 = resultListOfInterest(resultListOfInterest(:,1) ==13,:);% method
    resultListOfInterest15 = resultListOfInterest15(resultListOfInterest15(:,3) ==0,:);%init guess

        resultListOfInterest16 = resultListOfInterest(resultListOfInterest(:,1) ==14,:);% method
    resultListOfInterest16 = resultListOfInterest16(resultListOfInterest16(:,3) ==0,:);%init guess

        resultListOfInterest17 = resultListOfInterest(resultListOfInterest(:,1) ==15,:);% method
    resultListOfInterest17 = resultListOfInterest17(resultListOfInterest17(:,3) ==0,:);%init guess

        resultListOfInterest18 = resultListOfInterest(resultListOfInterest(:,1) ==16,:);% method
...
boxplot([resultListOfInterest1(:,6)/1000,resultListOfInterest2(:,6)/1000,resultListOfInterest3(:,6)/1000,resultListOfInterest4(:,6)/1000, ...
    ...
    resultListOfInterest9(:,6),resultListOfInterest10(:,6),resultListOfInterest11(:,6)/1000,resultListOfInterest12(:,6)/1000, ...
    resultListOfInterest13(:,6)/1000,resultListOfInterest14(:,6)/1000,resultListOfInterest15(:,6)/1000,resultListOfInterest16(:,6)/1000, ...
    resultListOfInterest17(:,6)/1000,resultListOfInterest18(:,6)/1000], ...
...
saveas(gcf,nameOfPdfFile, 'pdf' )
% system('pdfcrop ' + nameOfPdfFile + '.pdf '+nameOfPdfFile+ '.pdf');
addCommandToBatchfile("batchfile.sh",'pdfcrop ' + nameOfPdfFile + '.pdf '+nameOfPdfFile+ '.pdf &',true);
